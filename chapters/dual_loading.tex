...
\begin{figure}[H]
	...
	\caption{TOF trace of simultaneous \ce{Be} and \ce{C} ablation averaged over 10 shots. A soft A-ramp is applied after loading, ejecting any unintentionally loaded \ce{Cn} clusters.}
	\label{fig: Be C TOF}
\end{figure}