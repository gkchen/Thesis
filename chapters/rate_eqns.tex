...
\begin{align}
	...
	%	H_3O(t) & = \frac{\left([HCO]_0 e^{-k_{\ref{r: [HCO]+H2O->H3O}} \rho_{\ce{H2O}} t} - (H_3O_0 + [HCO]_0) \right)(k_{\ref{r: [HCO]+H2O->H3O}} - k_{\ref{r: C+H2O->HCO} + \ref{r: C+H2O->HOC}}) + C_0\left( k_{\ref{r: C+H2O->HCO} + \ref{r: C+H2O->HOC}} \left(1 - e^{-k_{\ref{r: [HCO]+H2O->H3O}} \rho_{\ce{H2O}} t}\right) + k_{\ref{r: [HCO]+H2O->H3O}} \left(e^{-k_{\ref{r: C+H2O->HCO} + \ref{r: C+H2O->HOC}} \rho_{\ce{H2O}} t} - 1\right) \right)}{k_{\ref{r: C+H2O->HCO} + \ref{r: C+H2O->HOC}} - k_{\ref{r: [HCO]+H2O->H3O}}} \label{eq: [HCO]+H2O->H3O(t)}
